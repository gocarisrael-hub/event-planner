...
import catalogRouter, { categoryRouter, clientRouter, ownerRouter, spaceRouter } from './routes/catalog.js';
...
app.get('/api/version', (_req, res) => res.json({ version: '2026-07-05-per-option-profit-addon-status' }));
