...
router.post('/:id/items', (req, res) => {
  ...
  let base = {
    ...
    price_min: b.price_min ?? null,
    price_max: b.price_max ?? null,
    approx_duration_min: b.approx_duration_min ?? null,
    photos: b.photos || [],
  ...
  if (b.from_catalog_id) {
    ...
    if (c) {
      base = {
        ...
        price_min: c.default_price_min,
        price_max: c.default_price_max,
        approx_duration_min: c.default_duration_min,
        photos: c.photos || [],
    ...
    const created = catalog.insert({
      ...
      default_duration_min: base.approx_duration_min,
      default_price_min: base.price_min,
      default_price_max: base.price_max,
